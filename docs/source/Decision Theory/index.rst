Decision Theory
=============================================
This chapter provides an introduction to decision theory, where we will focus on solving decision problems whre the decision maker must select among various alternatives, which provide different performance.
...
.. toctree::
    ...
    Decision Trees with Scikit Learn (SKLearn) </Decision Theory/tutorials/Decision_trees_in_machine_learning>
    Drawing decision trees in Python </Decision Theory/tutorials/Decision_trees_machine_learning_with_SKLearn>
